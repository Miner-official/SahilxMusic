...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Miner-official/SahilxMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Sahil_official_here")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/chat_official_sahil")
